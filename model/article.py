...
def LoadArticles():
	...
	art.add_p("从有搭窝想法开始就一直在yy搭完窝以后的幸福生活，其实也无非是可以喝着不管什么反正顺口的东西，窝在自己那个柠檬布丁里，晒着暖乎乎的大太阳(不好意思，当时还是冬天来着...)，然后或是梳理自己的一路走来，把它们一件件布置到窝里，或是娓娓道来当下的事当下的心情，又或是捣鼓一些很酷很好玩的事，一点点去完成自己一直以来的那个梦想，这是我现阶段能想到的最惬意的人生了。")
